...
from demo.home.blocks import BaseStreamBlock
...
class ProductsPage(Page):
    ...
    ingredients = ParentalManyToManyField('ProductsIngredient', blank=True)
...
class ProductsIndexPage(Page):
    ...
    def paginate(self, request, *args):
        ...
        paginator = Paginator(self.get_product(), 12)
        try:
    ...
    def get_context(self, request):
        ...
        products = self.paginate(request, self.get_product())
